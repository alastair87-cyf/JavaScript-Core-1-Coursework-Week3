...
function getAveragePrices(closingPricesForAllStocks) {
  return closingPricesForAllStocks.map((closingPricesForStock) =>
    roundTo2dp(
      closingPricesForStock.reduce((a, b) => a + b) /
        closingPricesForStock.length
    )
  );
}
...
function getPriceChanges(closingPricesForAllStocks) {
  return closingPricesForAllStocks.map((closingPricesForStock) =>
    roundTo2dp(
      closingPricesForStock[closingPricesForStock.length - 1] -
        closingPricesForStock[0]
    )
  );
}
